...
- RMarkdown/Quarto se usa para definir cómo se va a renderizar el documento (HTML, PDF, etc.), escribir metadatos (Autores, título, fecha...)

:::

::: footer
Más información sobre [formatos para renderizar](https://quarto.org/docs/output-formats/all-formats.html), [metadatos](https://quarto.org/docs/output-formats/all-formats.html)
:::
...
::: footer
[Sintáxis básica de Markdown](https://quarto.org/docs/authoring/markdown-basics.html#lists)
:::
