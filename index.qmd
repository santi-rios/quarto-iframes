...
format:
  revealjs:
    ...
    footer: "[Ver código de la presentación](https://github.com/santi-rios/quarto-iframes/)"
    # width: 1280
    # height: 720
    # chalkboard: 
      # buttons: true
...
## Gráficos Interactivos {background-iframe="./rotating-earth/index.html" background-interactive="False"}
